        ...
        <div class="panel panel-default bg-body-secondary container-fluid rounded-2 py-4">
            <div class="panel-heading py-2">
                ...
                <div class="d-sm-flex justify-content-end align-items-end flex-wrap">
                    ...
                    <li class="breadcrumb breadcrumb-item">
                        <a href="?page=laporan_barangkeluar" aria-current="page" class="text-decoration-none active">
                            Laporan Barang Keluar
                        </a>
                    </li>
                </div>
                            ...
                            <div class="card-body my-2">
                                <div class="card-tools">
                                    <div class="text-start">
                                        <a href="?page=laporan_barangkeluar" aria-current="page">
                                ...
                                <div class="card-footer my-2">
                                    ...
                                    <form action="?page=export_laporan_barangkeluar_excel" method="post">
                                    ...
                                    <form id="Myform2">
                                        <div class="form-inline my-2">
                                            ...
                                            <button type="submit" name="submit"
                                                class="btn btn-danger my-2">Tampilkan</button>
                                        </div>
                                    </form>
