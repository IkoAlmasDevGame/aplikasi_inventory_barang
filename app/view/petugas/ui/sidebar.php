...
<?php if ($_SESSION['user_akses'] == 'petugas' && $_SESSION['level'] == 'petugas'): ?>
<?php require_once("../../../config/config.php"); ?>
<?php
    $baseFiles = $koneksi->query("SELECT * FROM users WHERE id = '$_SESSION[petugas]' and level = '$_SESSION[level]'");
                ...
                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                    <li class="dropdown-header">
                        ...
                        <div class="text-center">
                            <a href="?page=user-profile&id=<?= $_SESSION['petugas'] ?>"
